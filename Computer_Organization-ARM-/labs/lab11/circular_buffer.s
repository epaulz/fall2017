...
put:
	...
	@ CODE HERE
	ldr r3, .L12		// address of count
	ldr r2, [r3]		// value of count
...
not_full:
	ldr r3, .L12+8		// address of in
	ldr r4, [r3]			// value of in
	ldr r5, .L12+12		// address of buffer array

	str r0, [r5, r4]	// store value in array at index

	add r4, r4, #1		// increment index
	and r4, r4, #7				// see if buffer is full
	str r4, [r3]

	ldr r3, .L12
	ldr r2, [r3]			// update global in
	add r2, r2, #1		// increment count
	str r2, [r3]			// update global count
